...
class ConcentrationCO2 : public Condition {
    public:
        ConcentrationCO2(double value, std::string unit);
        /**
         ...
         */
        void calcualteValue(double tempIn, double humIn, double co2Const1, double co2Const2, bool ventStatus, double peopleInside);
};

...
class Humidity : public Condition {
    public:
        Humidity(double value, std::string unit);
        /**
         ...
         */
        void calcualteValue(double tempIn, double humOut, double tempOut, double humConst1, bool ventStatus, double peopleInside);
};
